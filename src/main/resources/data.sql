...
(id,name,price,stock,review_sum,review_star,product_category_id,producter_id,shipping_interval) 
VALUES
('じゃがいも5kg',3000,50,2,3.5,1,1,CURRENT_TIMESTAMP + INTERVAL 2 DAY)
('冷凍鮭2kg',3000,30,2,4.0,2,2,CURRENT_TIMESTAMP + INTERVAL 5 DAY)
('ジンギスカンセット',5000,25,1,5.0,3,3,CURRENT_TIMESTAMP + INTERVAL 4 DAY)
('ナチュラルチーズ3種詰め合わせ',4500,12,1,4.0,4,4,CURRENT_TIMESTAMP + INTERVAL 3 DAY)
('贈答用ロイズチョコレート',4000,20,2,3.5,5,5,CURRENT_TIMESTAMP + INTERVAL 1 DAY)
('男山飲み比べセット',3500,10,3,3.0,6,6,CURRENT_TIMESTAMP + INTERVAL 1 DAY)
('木彫りの熊（ぽんこ）',5000,15,5,4.6,7,7,CURRENT_TIMESTAMP + INTERVAL 5 DAY);

INSERT INTO producers
(image_path,image_description,catchcopy,hokkaido_area_id)
VALUES
('a','aa','aaa',1)('b','bb','bbb',2)('c','cc','ccc',3)('d','dd','ddd',2)
('e','ee','eee',3)('f','ff','fff',1)('g','gg','ggg',1)('h','hh','hhh',2);

INSERT INTO product_categories(name)
VALUES('農作物')('海産物')('畜産品')('乳製品')('スイーツ')('酒・飲料')('消耗品');
